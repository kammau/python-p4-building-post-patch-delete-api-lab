...
def baked_goods():
    if request.method == "GET":
        ...
        response = make_response(
            jsonify(serialized_baked_goods),
            200
        )
        return response
        ...
        baked_to_dict = baked_good.to_dict()

        response = make_response(
            jsonify(baked_to_dict),
            201
        )
...
def baked_goods_by_id(id):
    ...
    if request.method == "GET":
        baked_good_to_dict = baked_good.to_dict()
        ...
        response_message = {"message": "baked good successfully deleted"}
